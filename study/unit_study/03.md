<task_result_03>
I now have enough data from the official docs to compile the comprehensive reference. Let me produce the full structured list.
...
crypto:verify(rsa, sha256, <<"data">>, Sig, Pub).
```
...
Functions: `call/2,3,4`, `cast/2,3,4`, `send_request/2,3,4`, `receive_response/1,2`, `wait_response/1,2`, `check_response/2`, `multicall/2,3,4,5`, `multicast/2,3,4`, `reqids_new/0`, `reqids_add/3`, `reqids_size/1`

```erlang
erpc:call(Node, Mod, Fun, Args),

ReqId = erpc:send_request(Node, Mod, Fun, Args),
erpc:receive_response(ReqId).
```
...
**Callbacks required:** `callback_mode/0`, `init/1`, state handlers or `handle_event/4`, optionally `terminate/3`, `code_change/4`, `format_status/1`

**Key API:** `start/3,4`, `start_link/3,4`, `start_monitor/3,4`, `stop/1,2,3`, `call/2,3`, `cast/2`, `send_request/2,3`, `receive_response/1,2`
...
Functions: `encode/1,2`, `decode/1,2`, `encode_to_string/1,2`, `decode_to_string/1,2`, `mime_decode/1,2`, `mime_decode_to_string/1,2`
...
Functions: `parse/1`, `compose_query/1,2`, `dissect_query/1`, `recompose/1`, `resolve_uri_string/2,3`, `normalize/1,2`, `transcode/2`, `percent_encode/1`, `percent_decode/1`, `quote/1,2`, `unquote/1`
...
Functions: `encode/1,2`, `decode/1,2`, `decode_start/2`, `decode_continue/2`, `format/1,2`, `format_value/2`
...
Store terms set rarely and read very frequently (near-zero read overhead — no copying). Writing triggers a global GC scan.

Functions: `put/2`, `get/1,2`, `erase/1`, `info/0`, `get/0`
...
Functions: `new/2`, `get/2`, `put/3`, `add/3`, `add_get/3`, `sub/3`, `sub_get/3`, `exchange/3`, `compare_exchange/4`, `info/1`
...
Simpler counter arrays optimized for high-frequency increments. Can be `write_concurrency` (distributed, eventually consistent) or atomics-backed.

Functions: `new/2`, `get/2`, `add/3`, `sub/3`, `put/3`, `info/1`
...
Functions: `q/1,2`, `eval/1,2`, `cursor/1,2`, `fold/3,4`, `next_answers/1,2`, `delete_cursor/1`, `info/1,2`, `append/1,2`, `sort/1,2`, `keysort/2,3`, `table/2`
...
Functions: `open/2`, `close/1`, `add/3,4`, `extract/1,2`, `table/1,2`, `format_error/1`, `create/2,3`
...
erl_tar:table("archive.tar.gz", [compressed]).
```
...
Mutable directed labeled graphs using ETS internally. `digraph_utils` provides graph algorithms.
